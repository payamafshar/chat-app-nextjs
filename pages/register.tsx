  ...
  const onSubmit = (data:any) => {
    ...
    return (
      ...
      <div className="w-2/5  h-2/5 flex flex-col">
        ...
        <input id="email"  {...register('email',{required:'firstname is required'})} className="w-full text-textInner p-3 bg-inputBgDark  rounded-md outline-none focus:ring-buttonBgDark focus:ring-1 " />
        <div className="flex justify-center items-center gap-x-2 w-full ">
           ...
           <label htmlFor="lastname" className="text-textInner text-xs font-semibold ">LastName</label>
            <input id="lastname"  {...register('lastname',{required:'firstname is required'})} className=" p-3 bg-inputBgDark rounded-md outline-none focus:ring-buttonBgDark focus:ring-1" />
           </div>
        </div>
